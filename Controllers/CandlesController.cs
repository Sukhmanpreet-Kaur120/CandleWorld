...
namespace CandleWorld.Controllers
{
    public class CandlesController : Controller
    {
        private readonly CandleWorldContext _context;

        public CandlesController(CandleWorldContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Tradingdate,Fragrance,Wax,Price")] Candle candle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Tradingdate,Fragrance,Wax,Price")] Candle candle)
        {
            if (id != candle.Id)
            {
                return NotFound();
